...
\begin{thebibliography}{100}
        \bibitem{github_reference} \textbf{GitHub repository that contains the notebook of all the experiments described in this report} \href{https://github.com/IrfEazy/naml-project}{https://github.com/IrfEazy/naml-project}
    \end{thebibliography}
\end{document}
